...
<link rel="stylesheet" type="text/css" href="{{ secure_asset('js/backGeneral/customer/signature/signatureButtons.css') }}" defer />
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<script type="text/javascript" src="{{ secure_asset('js/backGeneral/customer/signature/BigInt.js') }}" defer></script>
<script type="text/javascript" src="{{ secure_asset('js/backGeneral/customer/signature/sjcl.js') }}" defer></script>
<script type="text/javascript" src="{{ secure_asset('js/backGeneral/customer/signature/signatureButtons_encryption.js') }}" defer></script>
<script src="{{ secure_asset('js/backGeneral/customer/signature/q.js') }}" defer charset="UTF-8"></script>
<script src="{{ secure_asset('js/backGeneral/customer/signature/wgssStuSdk.js') }}" defer charset="UTF-8"></script>
